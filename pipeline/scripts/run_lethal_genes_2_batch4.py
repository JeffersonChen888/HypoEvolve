#!/usr/bin/env python3
"""
Batch 4: Process prompts 16-19 (final batch)

Usage:
    python pipeline3/scripts/run_lethal_genes_2_batch4.py [--population-size N] [--generations N] [--model MODEL]

Example:
    python pipeline3/scripts/run_lethal_genes_2_batch4.py --population-size 6 --generations 3 --model gpt-4o
"""
...
# Batch configuration
BATCH_NUMBER = 4
START_INDEX = 15  # 0-indexed
END_INDEX = 19    # Exclusive (processes prompts 15-18, which are 16-19 in 1-indexed)
