#!/usr/bin/env python3
"""
Batch 2: Process prompts 6-10

Usage:
    python pipeline3/scripts/run_lethal_genes_2_batch2.py [--population-size N] [--generations N] [--model MODEL]

Example:
    python pipeline3/scripts/run_lethal_genes_2_batch2.py --population-size 6 --generations 3 --model gpt-4o
"""
...
# Batch configuration
BATCH_NUMBER = 2
START_INDEX = 5  # 0-indexed
END_INDEX = 10   # Exclusive (processes prompts 5-9, which are 6-10 in 1-indexed)
