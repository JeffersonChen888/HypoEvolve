...
# Model configuration
LLM_MODEL = os.getenv("LLM_MODEL", "gpt-4o-mini")  # Default to GPT-4o-mini (reliable and cost-effective)
...
# Output settings
OUTPUT_DIR = os.getenv("OUTPUT_DIR", "pipeline3/output")
...
LOG_FILE = os.path.join(OUTPUT_DIR, f'pipeline3_{TIMESTAMP}.log')
