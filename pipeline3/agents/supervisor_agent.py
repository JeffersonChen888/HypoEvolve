...
class SupervisorAgent:
    ...
    def __init__(self, research_goal: str, mode: str = "drug-repurposing", batch_mode: bool = False, run_folder: str = None, prompt_file: str = None):
        ...
        self.ranking_agent = RankingAgent(mode=mode)
    ...
    def _run_generation(self) -> None:
        ...
        # GA-aligned approach: Skip pre-selection, do per-offspring tournament selection
        # (RankingAgent _select_parents method preserved but not invoked)
    ...
    def _evaluate_population_fitness(self) -> None:
        ...
        for eval_result in self.fitness_evaluations:
            ...
            fitness = eval_result.get('fitness', 'Unknown')
    ...
    def _compile_final_results(self) -> Dict[str, Any]:
        ...
        final_ranking = self.ranking_agent.rank_population(
            self.population, self.fitness_evaluations
        )
